...
Blockly.Java['math_number'] = function(block) {
  ...
  var order = code >= 0 ? Blockly.Java.ORDER_ATOMIC :
              Blockly.Java.ORDER_UNARY_NEGATION;
  return [code, order];
};
...
Blockly.Java['math_atan2'] = function(block) {
  // Arctangent of point (X, Y) in degrees from -180 to 180.
  var argument0 = Blockly.Java.valueToCode(block, 'X',
      Blockly.Java.ORDER_COMMA) || '0';
  var argument1 = Blockly.Java.valueToCode(block, 'Y',
      Blockly.Java.ORDER_COMMA) || '0';
  return ['Math.atan2(' + argument1 + ', ' + argument0 + ') / Math.PI * 180',
      Blockly.Java.ORDER_DIVISION];
};
